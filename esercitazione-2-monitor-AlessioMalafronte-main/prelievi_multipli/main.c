...
int main()
{
    ...
    int shm_id = shmget(IPC_PRIVATE, sizeof(ProdCons), IPC_CREAT | 0644);/* TBD: Allocazione della struttura dati in shared memory */
    ...
    ProdCons *p = shmat(shm_id, NULL, 0);/* TBD: Attach della shared memory */
