...
int main() {
	...
	*/
	...
	id_shm = shmget(IPC_PRIVATE, sizeof(MonitorSchedulatore), IPC_CREAT|0664);/* TBD: Effettuare la allocazione di memoria condivisa per la struttura dati */
	...
	*/
	...
	MonitorSchedulatore * s = shmat(id_shm, NULL, 0);/* TBD: Effettuare l'attach */
