...
int main(int argc,char* argv[])
{
	...
	id_prod_cons= shmget(IPC_PRIVATE, siezeof(PriorityProdCons), IPC_CREAT | 0644); /* TBD: Allocare una memoria condivisa per la struttura "PriorityProdCons" */

	printf("[DEBUG] - id_monitor=%d \n",id_prod_cons);
    
	p = (PriorityProdCons *) (shmat(id_prod_cons, 0, 0));           /* TBD: Effettuare l'attach della memoria condivisa */
